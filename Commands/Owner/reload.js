...
module.exports = {
    ...
    async execute(interaction, client){
        const {user} = interaction
                    ...
                    // TU ID //
        if(user.id !== 'TU ID') return interaction.reply({embeds:[new EmbedBuilder().setColor('Random').setDescription('This command is only for the bot developer')], ephemeral:true})
